  ...
  return (
    <main className="bg-background min-h-screen">
      ...
      <section className="w-full flex flex-col justify-center items-center">
        ...
        >
          <motion.img initial={{ scale: 1.05 }} animate={{ scale: 1 }} style={{ scale: scaleImage }} transition={{ duration: 0.5, delay: 1.5 }} src={ourImage2.src} alt="Our Image" className=" w-full object-cover aspect-3/4 xl:aspect-square" />
        </motion.div>
